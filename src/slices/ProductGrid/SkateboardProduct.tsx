...
export async function SkateboardProduct({ id }: Props) {
  ...
  return (
    <div className="group relative mx-auto w-full max-w-72 px-8 pt-4">
      <VerticalLine className={clsx(VERTICAL_LINE_CLASSSES, "left-4")} />
      <VerticalLine className={clsx(VERTICAL_LINE_CLASSSES, "right-4")} />
      <HorizontalLine className={HORIZONTAL_LINE_CLASSSES} />
